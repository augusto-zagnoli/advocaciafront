...
import { QuemSomosService } from '../../../core/services/site.service';
import { QuemSomos, CreateQuemSomos } from '../../../core/models/models';

@Component({
  selector: 'app-admin-quem-somos',
  standalone: true,
  ...
  template: `
    <div>
      <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
          <h4 class="fw-bold text-navy mb-1">Quem Somos</h4>
          <p class="text-muted mb-0">Gerencie o conteúdo da seção "Quem Somos" do site</p>
        </div>
          ...
          <form [formGroup]="form" (ngSubmit)="salvar()">
            <div class="row g-3">
              ...
              <div class="col-12">
                ...
                <textarea class="form-control" formControlName="descricao" rows="5"
              ...
              <div class="col-md-3 d-flex align-items-end">
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" formControlName="ativo" id="ativoQS">
                  <label class="form-check-label fw-semibold" for="ativoQS">Ativo</label>
                </div>
              </div>
            </div>
...
export class AdminQuemSomosComponent implements OnInit {
  items: QuemSomos[] = [];
  carregando = false;
  salvando = false;
  mostrarForm = false;
  ...
  constructor(private fb: FormBuilder, private service: QuemSomosService) {
  ...
  salvar(): void {
    ...
    this.salvando = true;
    const dto = this.form.value as CreateQuemSomos;
